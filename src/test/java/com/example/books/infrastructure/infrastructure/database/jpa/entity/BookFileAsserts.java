...
public class BookFileAsserts {
     ...
     */
    public static void assertBookFileAllPropertiesEquals(BookFileEntity expected, BookFileEntity actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertBookFileAllUpdatablePropertiesEquals(BookFileEntity expected, BookFileEntity actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertBookFileAutoGeneratedPropertiesEquals(BookFileEntity expected, BookFileEntity actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertBookFileUpdatableFieldsEquals(BookFileEntity expected, BookFileEntity actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertBookFileUpdatableRelationshipsEquals(BookFileEntity expected, BookFileEntity actual) {
        assertThat(actual)
