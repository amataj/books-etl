...
public class BookPageTextAsserts {
     ...
     */
    public static void assertBookPageTextAllPropertiesEquals(BookPageTextEntity expected, BookPageTextEntity actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertBookPageTextAllUpdatablePropertiesEquals(BookPageTextEntity expected, BookPageTextEntity actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertBookPageTextAutoGeneratedPropertiesEquals(BookPageTextEntity expected, BookPageTextEntity actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertBookPageTextUpdatableFieldsEquals(BookPageTextEntity expected, BookPageTextEntity actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertBookPageTextUpdatableRelationshipsEquals(BookPageTextEntity expected, BookPageTextEntity actual) {
        assertThat(actual)
