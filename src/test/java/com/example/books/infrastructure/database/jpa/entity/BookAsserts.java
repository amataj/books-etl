...
public class BookAsserts {
     ...
     */
    public static void assertBookAllPropertiesEquals(BookEntity expected, BookEntity actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertBookAllUpdatablePropertiesEquals(BookEntity expected, BookEntity actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertBookAutoGeneratedPropertiesEquals(BookEntity expected, BookEntity actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertBookUpdatableFieldsEquals(BookEntity expected, BookEntity actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertBookUpdatableRelationshipsEquals(BookEntity expected, BookEntity actual) {
        // empty method
    }
}
