...
class UserMapperTest {
    ...
    private com.example.books.infrastructure.database.jpa.entity.User user;
    private AdminUser userDto;

    @BeforeEach
    void init() {
        userMapper = new UserMapper();
        user = new com.example.books.infrastructure.database.jpa.entity.User();
        ...
        userDto = new AdminUser(user);
    }

    @Test
    void testUserToUserDTO() {
        AdminUser convertedUserDto = userMapper.userToAdminUserDTO(user);
    ...
    void testUserDTOtoUser() {
        com.example.books.infrastructure.database.jpa.entity.User convertedUser = userMapper.userDTOToUser(userDto);
    ...
    void usersToUserDTOsShouldMapOnlyNonNullUsers() {
        List<com.example.books.infrastructure.database.jpa.entity.User> users = new ArrayList<>();
        users.add(user);
        users.add(null);
    ...
    void userDTOsToUsersShouldMapOnlyNonNullUsers() {
        List<AdminUser> usersDto = new ArrayList<>();
        usersDto.add(userDto);
        usersDto.add(null);

        List<com.example.books.infrastructure.database.jpa.entity.User> users = userMapper.userDTOsToUsers(usersDto);
    ...
    void userDTOToUserMapWithNullAuthoritiesStringShouldReturnUserWithEmptyAuthorities() {
        ...
        com.example.books.infrastructure.database.jpa.entity.User persistUser = userMapper.userDTOToUser(userDto);
