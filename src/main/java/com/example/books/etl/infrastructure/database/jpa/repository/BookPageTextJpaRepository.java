...
import com.example.books.etl.infrastructure.database.jpa.entity.BookPageTextEntity;
 ...
 */
@Repository
public interface BookPageTextJpaRepository extends JpaRepository<BookPageTextEntity, Long> {
