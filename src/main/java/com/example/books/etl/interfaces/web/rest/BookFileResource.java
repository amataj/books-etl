...
import com.example.books.etl.application.bookfile.BookFileUseCase;
import com.example.books.etl.domain.bookfile.BookFile;
import com.example.books.etl.infrastructure.database.jpa.entity.BookFileEntity;
...
public class BookFileResource {
    ...
    private final BookFileUseCase bookFileService;

    private final BookFileJpaRepository bookFileRepository;

    public BookFileResource(BookFileUseCase bookFileService, BookFileJpaRepository bookFileRepository) {
