...
@Component
public class KafkaSseMessageConsumer implements Consumer<String> {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaSseMessageConsumer.class);
    ...
    public void accept(String input) {
        ...
        LOG.debug("Broadcasting message to SSE: {}", input);
        emitters
            .entrySet()
            .stream()
