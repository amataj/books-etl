  ...
  return (
    <div>
      <h2 id="book-heading" data-cy="BookHeading">
        <Translate contentKey="booksEtlApp.book.home.title">Books</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="booksEtlApp.book.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/book/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="booksEtlApp.book.home.createLabel">Create new Book</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bookList && bookList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="booksEtlApp.book.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('lang')}>
                  <Translate contentKey="booksEtlApp.book.lang">Lang</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('lang')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="booksEtlApp.book.home.notFound">No Books found</Translate>
            </div>
          )
        )}
      </div>
