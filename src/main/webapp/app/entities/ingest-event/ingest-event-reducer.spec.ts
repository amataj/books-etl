...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGESTEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INGESTEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INGESTEVENT actions', async () => {
      const arg = { id: 14502 };
    ...
    it('dispatches UPDATE_INGESTEVENT actions', async () => {
      const arg = { id: 14502 };
    ...
    it('dispatches PARTIAL_UPDATE_INGESTEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INGESTEVENT actions', async () => {
      const arg = 42666;
