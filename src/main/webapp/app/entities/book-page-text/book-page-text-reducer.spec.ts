...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKPAGETEXT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKPAGETEXT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKPAGETEXT actions', async () => {
      const arg = { id: 7733 };
    ...
    it('dispatches UPDATE_BOOKPAGETEXT actions', async () => {
      const arg = { id: 7733 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKPAGETEXT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKPAGETEXT actions', async () => {
      const arg = 42666;
