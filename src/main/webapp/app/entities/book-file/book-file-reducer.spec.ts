...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './book-file.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKFILE actions', async () => {
      const arg = { id: 19907 };
    ...
    it('dispatches UPDATE_BOOKFILE actions', async () => {
      const arg = { id: 19907 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKFILE actions', async () => {
      const arg = 42666;
