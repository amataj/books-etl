...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGESTRUN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INGESTRUN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INGESTRUN actions', async () => {
      const arg = { id: 26980 };
    ...
    it('dispatches UPDATE_INGESTRUN actions', async () => {
      const arg = { id: 26980 };
    ...
    it('dispatches PARTIAL_UPDATE_INGESTRUN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INGESTRUN actions', async () => {
      const arg = 42666;
